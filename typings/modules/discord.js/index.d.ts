...
declare module 'discord.js' {
	...
	export class Webhook {
		...
		send(content?: StringResolvable, options?: WebhookMessageOptions): Promise<Message>;
		send(options?: WebhookMessageOptions): Promise<Message>;
		sendCode(lang: string, content: StringResolvable, options?: WebhookMessageOptions): Promise<Message>;
		sendFile(attachment: BufferResolvable, name?: string, content?: StringResolvable, options?: WebhookMessageOptions): Promise<Message>;
		sendMessage(content?: StringResolvable, options?: WebhookMessageOptions): Promise<Message>;
		sendMessage(options?: WebhookMessageOptions): Promise<Message>;
